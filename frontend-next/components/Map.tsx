...
function Map({ value, error, handleChange }: Props) {
  return (
    <div>
      ...
      >
        <g className="svg-container">
          ...
          <text
            ...
            fontStyle="normal"
            stroke="null"
            transform="matrix(1.06356 0 0 1 -15.2986 0)"
          >
            Liberecký
          </text>
          <text
